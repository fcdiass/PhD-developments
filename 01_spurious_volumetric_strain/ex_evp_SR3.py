...
def main(debug=False, graphical_interface=True, write_input_files=True):
    ...
    # Lista de materiais
    materials = [
        SoftRockPlasticity.from_classical_parameters_and_pc(17000, 0.3, 34, 24, 6, 120)
    ] * 4

    # Cria as camadas
    divisions = [-1000 * cos_angle, -1500 * cos_angle, -2000 * cos_angle]
    ...
    # Tensões iniciais
    damagezone.init_cond.set_stress(SPLinear(0.0, [0.012] * 4, [1] * 4))
